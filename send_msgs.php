...
<div class="container sent_msgs">
	<?php
		...
		if ($user_snum == $serial_num){
			...
			echo "<br><div class='container-fluid message_compose' style='margin-top:12px;'>
				  <form action='send_msgs.php?u=$serial_num' method='POST'>
					  <h1>ماذا ستقول ل$first_name ؟</h1><hr>
					  <div class='row'>
		...
		if (isset($_POST['send_msg'])){
			...
			if($msg_title == ""){
				...
				$send_msg = mysql_query("INSERT INTO messages VALUES ('','$user_snum','$user_fname','$user_lname','$serial_num','$first_name','$last_name','$msg_title','$msg_content','$msg_date','$read_status','$delete_status','$remove_status')");
